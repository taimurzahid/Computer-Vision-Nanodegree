...
#             #print(landmark)
#             #print(str(index) + ' ' + str(landmark_x) + ' ' + str(landmark_y))
...
#         return measurements
        for landmark in range(self.num_landmarks): #Changed
            #index, x, y = landmark
            landmark_x, landmark_y = self.landmarks[landmark] #Changed
            # l_x is self.landmarks[landmark][0]; l_y is self.landmarks[landmark][1]
            #print(landmark)
            #print(str(index) + ' ' + str(landmark_x) + ' ' + str(landmark_y))
            dx = landmark_x - self.x
            dy = landmark_y - self.y
